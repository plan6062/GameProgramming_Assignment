...
namespace KinematicCharacterController
{
    ...
    /// </summary>
    /// 대상 오브젝트(RigidBody)의 물리적 상태를 저장하는 구조체
    [System.Serializable]
    public struct PhysicsMoverState
    {
        public Vector3 Position; //위치
        public Quaternion Rotation; //회전 값
        public Vector3 Velocity; //속도
        public Vector3 AngularVelocity; //각 속도
    }
    ...
    public class PhysicsMover : MonoBehaviour
    {
        ...
        /// </summary>
        [ReadOnly]
        public Rigidbody Rigidbody; //대상 RigidBody

        /// <summary>
        /// Determines if the platform moves with rigidbody.MovePosition (when true), or with rigidbody.position (when false)
        /// MoveWithPhysics = true로 하면 물리 시뮬레이션을 거쳐서 움직임, false로 하면 즉시 대상 위치로 움직임. true로 설정해야 함
        /// </summary>
        ...
        /// </summary>
        [NonSerialized]
        public IMoverController MoverController; //오브젝트 이동 관련 스크립트에 상속되는 추상 클래스
        /// <summary>
